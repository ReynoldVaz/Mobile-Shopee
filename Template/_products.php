                    ...
                    <div class="col">
                         <form method="post" class="col" >
                            ...
                            if(in_array($item['item_id'], $Cart->getCartId($product->getData('cart')) ?? [])){
                                echo '<button type="submit" disabled class="btn btn-default btn-block btn-success font-size-16 ">In the Cart</button>';
                            }
                            else{
                                echo '<button type="submit" name="product_submit" class="btn btn-default btn-block btn-warning font-size-16">Add to Cart</button>';
                            }
                            ?>
